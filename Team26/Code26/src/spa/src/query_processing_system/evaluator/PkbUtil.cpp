...
std::unordered_set<std::string> PkbUtil::getEntitiesFromPkb(std::shared_ptr<ReadStroage> storage,
                                                            DesignEntity entity) {
...
std::unordered_set<std::string> PkbUtil::getStringEntitiesFromPkb(std::shared_ptr<ReadStroage> storage,
                                                                  DesignEntity entity) {
    switch (entity) {
...
std::unordered_set<int> PkbUtil::getIntEntitiesFromPkb(std::shared_ptr<ReadStroage> storage, DesignEntity entity) {
    switch (entity) {
