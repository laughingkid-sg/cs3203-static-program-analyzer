...
class IRelationshipStoreHelper {
 public:
    ...
    virtual bool procedureEntitiesContains(std::string procedureName) = 0;
    ...
    virtual std::unordered_map<std::string, std::unordered_set<std::string>> getCallsPReversedRelationship() = 0;
