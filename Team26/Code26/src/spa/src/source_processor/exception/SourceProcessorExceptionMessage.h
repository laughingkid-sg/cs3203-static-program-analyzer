...
extern const char ManagerInvalidInputFile[];

extern const char TokenizerInvalidLogicalOpExceptionMessage[];
...
extern const char ParserMissingThenKeywordExceptionMessage[];
extern const char ParserMissingElseKeywordExceptionMessage[];
extern const char ParserInvalidCondExprExceptionMessage[];
extern const char ParserInvalidBinaryCondExprFormatExceptionMessage[];
extern const char ParserMissingRelOperatorExceptionMessage[];
extern const char ParserInvalidRelExprExceptionMessage[];
extern const char ParserInvalidExprFormatExceptionMessage[];
extern const char ParserInvalidOpExceptionMessage[];
